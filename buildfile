...
{{
  ...
  b install: $msvc_release_out/readjson-boost/
  b install: $msvc_debug_out/readjson-boost/
  b install: $clang_release_out/readjson-boost/
  b install: $clang_debug_out/readjson-boost/
}}
